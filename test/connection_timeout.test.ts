...
Deno.test('ImapConnection', async (t) => {
  await t.step('Socket timeout handling', async () => {
  ...
  await t.step('Socket activity reset on operations', async () => {
  ...
  await t.step('Socket activity cleanup', async () => {
    // Create a connection
    const connection = new ImapConnection({
      host: 'localhost',
      port: 143,
  ...
  await t.step('Connect resets socket activity state', async () => {
    // Create a connection
    const connection = new ImapConnection({
      host: 'localhost',
      port: 143,
