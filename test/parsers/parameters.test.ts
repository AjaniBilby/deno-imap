...
Deno.test('ParseParenthesizedList', async (t) => {
  ...
  await t.step('Nested structures', () => {
    // Simple nesting
    assertEquals(
  ...
  await t.step('IMAP ENVELOPE example', () => {
  ...
  await t.step('Complex IMAP example', () => {
    const complex =
